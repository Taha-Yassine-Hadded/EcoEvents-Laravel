        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-project-box">
                        <div class="project-thumb">
                            <img src="{{ Vite::asset('resources/assets/images/home1/project-4.jpg') }}" alt="">
                        </div>
                        <div class="project-content">
                            <h4>Climate</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-project-box">
                        <div class="project-thumb">
                            <img src="{{ Vite::asset('resources/assets/images/home1/project-5.jpg') }}" alt="">
                        </div>
                        <div class="project-content">
                            <h4>Plants</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-project-box">
                        <div class="project-thumb">
                            <img src="{{ Vite::asset('resources/assets/images/home1/project-6.jpg') }}" alt="">
                        </div>
                        <div class="project-content">
                            <h4>Environment</h4>
