                    ...
                    <form id="campaignForm" method="POST" action="{{ route('admin.campaigns.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-section" id="section2" style="display: none;">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="content" name="content" class="form-control" rows="10" placeholder="Décrivez en détail votre campagne : objectifs, actions à mener, comment participer, ressources disponibles, etc." required></textarea>
                        ...
                        <div class="form-section" id="section3" style="display: none;">
                            ...
                            <div class="form-group">
                                <label for="video_url">Lien vidéo (optionnel)</label>
                                <input type="url" id="video_url" name="video_url" class="form-control" placeholder="https://www.youtube.com/watch?v=...">
                                <div class="form-text">Ajoutez un lien YouTube, Vimeo ou autre pour enrichir votre campagne</div>
                            </div>
                            ...
                            <div class="form-group">
                                <label>
                                    ...
                                    J'accepte les <a href="#" target="_blank">conditions d'utilisation</a> et confirme que cette campagne respecte les valeurs environnementales d'ecoEvent <span class="required">*</span>
                                </label>
