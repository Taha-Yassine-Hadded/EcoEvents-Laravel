            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="about-thumb">
                        <img src="{{ asset('assets/images/home2/about-thumb.png') }}" alt="">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-right">
                        <div class="section-title left">
                            <h4><img src="{{ asset('assets/images/home1/section-shape.png') }}" alt="">Get to know echofy</h4>
                            <h1>Environmental Sustainable</h1>
                            <h1>Forever Green Future</h1>
                        </div>
                        <div class="about-text">
                            <span><img src="{{ asset('assets/images/home2/shape.png') }}" alt=""></span><a href="#">We’ve 10+ years of Experience Ecology</a>
                        </div>
                        ...
                        <div class="about-single-box">
                            <div class="about-author-box">
                                <div class="about-author">
                                    <img src="{{ asset('assets/images/home2/about-author.png') }}" alt="">
                                </div>
                            ...
                            <div class="echofy-button">
                                <a href="{{ url('/about') }}">More About <img src="{{ asset('assets/images/home1/button-shape.png') }}" alt=""></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-counter-box">
                        <div class="conuter-icon">
                            <img src="{{ asset('assets/images/home1/counter-icon-1.png') }}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-counter-box">
                        <div class="conuter-icon">
                            <img src="{{ asset('assets/images/home1/counter-icon-2.png') }}" alt="">
                        </div>
                        <div class="counter-content">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-counter-box">
                        <div class="conuter-icon">
                            <img src="{{ asset('assets/images/home1/counter-icon-3.png') }}" alt="">
                        </div>
                        <div class="counter-content">
            ...
            <div class="row align-items-center" id="process-row">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="process-left">
                        ...
                        <div class="echofy-button">
                            <a href="{{ url('/contact') }}">Contact Us <img src="{{ asset('assets/images/home1/button-shape.png') }}" alt=""></a>
                            <img class="two" src="{{ asset('assets/images/home1/button-shape-2.png') }}" alt="">
                        </div>
                ...
                <div class="brand-list-2 owl-carousel">
                    ...
                    <div class="col-md-12">
                        <div class="single-brand-box">
                            <img src="{{ asset('assets/images/home2/brand-'.$i.'.png') }}" alt="Brand {{$i}}">
                        </div>
                    </div>
                    @endfor
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-team-box">
                        <div class="single-team-thumb">
                            <img src="{{ asset('assets/images/home1/'.$member['img']) }}" alt="{{ $member['name'] }}">
                        </div>
                        ...
                        <div class="single-testimonial-box">
                            ...
                            <div class="testi-author">
                                <div class="testi-author-thumb">
                                    <img src="{{ asset('assets/images/home1/'.$testi['img']) }}" alt="{{ $testi['name'] }}">
                                </div>
